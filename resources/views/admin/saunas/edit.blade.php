                    ...
                    <form action="{{ route('admin.saunas.update', ['saunaFacilityId' => $saunaFacility->id]) }}" method="POST" class="space-y-6　flex flex-wrap -m-2" enctype="multipart/form-data">
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input type="text" id="name" name="name" value="{{ is_null(old('name')) ? $saunaFacility->name : old('name') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            {{-- 施設名のエラーメッセージ --}}
                            @error('name')
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    id="prefecture"
                                    name="prefecture"
                                    value="{{ is_null(old('prefecture')) ? $saunaFacility->prefecture : old('prefecture') }}"
                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                >
                            </div>
                            {{-- 都道府県のエラーメッセージ --}}
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('city')) ? $saunaFacility->city : old('city') }}</textarea>
                            </div>
                            {{-- 市区町村のエラーメッセージ --}}
                            @error('city')
                                <div class="alert alert-danger text-red-700">{{ $message }}</div>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('address')) ? $saunaFacility->address : old('address') }}</textarea>
                            </div>
                        </div>
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('access')) ? $saunaFacility->access : old('access') }}</textarea>
                            </div>
                            {{-- アクセスのエラーメッセージ --}}
                            @error('access')
                                <div class="alert alert-danger text-red-700">{{ $message }}</div>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('location_map')) ? $saunaFacility->location_map : old('location_map') }}</textarea>
                            </div>
                        </div>
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('price')) ? $saunaFacility->price : old('price') }}</textarea>
                            </div>
                            {{-- 料金のエラーメッセージ --}}
                            @error('price')
                                <div class="alert alert-danger text-red-700">{{ $message }}</div>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input type="file" id="image_path" name="image_path" value="{{ is_null(old('image_path')) ? $saunaFacility->image_path : old('image_path')}}" class="col-span-2  p-2 rounded-lg">
                                        ...
                                        <tr>
                                            <td class="px-4 py-3">
                                                <select name="sauna_type[]" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                    <option value="1" {{ $sauna->type == '1' ? 'selected' : '' }}>乾式サウナ（ドライサウナ）</option>
                                                    <option value="2" {{ $sauna->type == '2' ? 'selected' : '' }}>湿式サウナ（スチームサウナ）</option>
                                                    <option value="3" {{ $sauna->type == '3' ? 'selected' : '' }}>湿式サウナ（ミストサウナ）</option>
                                                    <option value="4" {{ $sauna->type == '4' ? 'selected' : '' }}>ロウリュサウナ</option>
                                                </select>
                                            ...
                                            <td class="px-4 py-3">
                                                <input type="text" name="temperature[]" value="{{ $sauna->temperature }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('saunaComment')) ? $saunaFacility->sauna_comment : old('saunaComment') }}</textarea>
                            </div>
                            {{-- サウナ備考のエラーメッセージ --}}
                            @error('saunaComment')
                                <div class="alert alert-danger text-red-700">{{ $message }}</div>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('loylyComment')) ? $saunaFacility->loyly_comment : old('loylyComment') }}</textarea>
                            </div>
                            {{-- ロウリュ備考のエラーメッセージ --}}
                            @error('loylyComment')
                                <div class="alert alert-danger text-red-700">{{ $message }}</div>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('waterbathComment')) ? $saunaFacility->water_bath_comment : old('waterbathComment') }}</textarea>
                            </div>
                            {{-- 水風呂備考のエラーメッセージ --}}
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('chairComment')) ? $saunaFacility->chair_comment : old('chairComment') }}</textarea>
                            </div>
                            {{-- ととのい椅子備考のエラーメッセージ --}}
                            @error('chairComment')
                                <div class="alert alert-danger text-red-700">{{ $message }}</div>
