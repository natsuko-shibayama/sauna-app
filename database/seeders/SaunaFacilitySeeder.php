    ...
    public function run(): void
    {
        DB::table('sauna_facilities')->insert(
            [
                ...
                'price' => '■ 朝ウナ(6:00〜9:59) 800円  ■ 通常(10:00〜24:00) 60分: 1,200円 90分: 1,500円 120分: 1,800円 平日限定フリー(3時間以上): 2,400円',
                ...
                'has_water_bath' => 1,
                'water_bath_comment' => '男性：シングルの水風呂（9℃以下）、水風呂（14~15℃）、女性：水風呂（16~17℃）',
                'has_outdoor_bath' => 0,
                'has_chair' => 1,
