        ...
        <form method="GET"
            ...
            <div class="flex items-center justify-between w-full">
                ...
                <span class="text-gray-500">
                    ...
                    {{ $filters->isEmpty() ? '指定されていません' : $filters->values()->join(', ') }}
                </span>
                <button
                    type="button"
            ...
            <div class="flex items-center justify-between w-full">
                ...
                <span class="text-gray-500">
                    ...
                    {{ $areas->isEmpty() ? '指定されていません' : $areas->values()->join(', ') }}
                </span>
                <button
                    type="button"
                    id="user_search_area"
            ...
            <div class="modal-content bg-white p-6 rounded-lg">
                ...
                {{-- <form method="GET"> --}}
                    ...
                    <div class="flex space-x-4">
                        <button type="button" id="select_kodawari" class="text-white bg-green-400 p-4 rounded-lg shadow-md hover:bg-green-800">
                            選択
                        </button>
        ...
        <div id="user_searchAreaModal" class="modal hidden fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center">
            <div class="modal-content bg-white p-6 rounded-lg">
                ...
                {{-- <form method="GET"> --}}
                    ...
                    <div class="flex space-x-4">
                        <button type="button" id="select_area" class="text-white bg-green-400 p-4 rounded-lg shadow-md hover:bg-green-800">
                            選択
                        </button>
    ...
    <section class="m-10">
        ...
        <div class="space-y-6">
            @forelse ($saunaFacilities as $saunaFacility)
                <a href="{{ route('saunaFacilities', ['saunaFacilityId' => $saunaFacility->id]) }}" class="block border rounded-lg shadow-md p-4 max-w-4xl mx-auto flex items-stretch">
                    <!-- 画像 -->
                    <img
                        src="{{ asset('storage/'.$saunaFacility->image_path) }}"
                        alt="{{ $saunaFacility->name }}"
                        class="w-1/3 h-48 object-cover rounded-md"
                    />
                    <!-- 詳細情報 -->
