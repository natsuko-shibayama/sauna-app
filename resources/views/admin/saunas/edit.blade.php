        ...
        <section class="text-gray-600 body-font relative">
            <div class="container px-5 py-24 mx-auto">
                ...
                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                    <form action="{{ route('admin.saunas.update', ['saunaId' => $sauna->id]) }}" method="POST" class="space-y-6　flex flex-wrap -m-2" enctype="multipart/form-data">
                        @csrf
                        <div class="p-2 w-full">
                            <div class="relative">
                                <label for="name" class="leading-7 text-sm text-gray-600">施設名</label>
                                <input type="text" id="name" name="name" value="{{ is_null(old('name')) ? $sauna->name : old('name') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            {{-- 施設名のエラーメッセージ --}}
                            @error('name')
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    id="postal_code"
                                    name="postal_code"
                                    value="{{ is_null(old('postal_code')) ? $sauna->postal_code  : old('postal_code') }}"
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    id="prefecture"
                                    name="prefecture"
                                    value="{{ is_null(old('prefecture')) ? $sauna->prefecture : old('prefecture') }}"
                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                >
                            </div>
                            {{-- 都道府県のエラーメッセージ --}}
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('city')) ? $sauna->city : old('city') }}</textarea>
                            </div>
                            {{-- 市区町村のエラーメッセージ --}}
                            @error('city')
                                <div class="alert alert-danger text-red-700">{{ $message }}</div>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('address')) ? $sauna->address : old('address') }}</textarea>
                            </div>
                        </div>
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('access')) ? $sauna->access : old('access') }}</textarea>
                            </div>
                            {{-- アクセスのエラーメッセージ --}}
                            @error('access')
                                <div class="alert alert-danger text-red-700">{{ $message }}</div>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('location_map')) ? $sauna->location_map : old('location_map') }}</textarea>
                            </div>
                        </div>
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('price')) ? $sauna->price : old('price') }}</textarea>
                            </div>
                            {{-- 料金のエラーメッセージ --}}
                            @error('price')
                                <div class="alert alert-danger text-red-700">{{ $message }}</div>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input type="file" id="image_path" name="image_path" value="{{ is_null(old('image_path')) ? $sauna->image_path : old('image_path')}}" class="col-span-2  p-2 rounded-lg">
                                @if ($sauna->image_path)
                                    <img src="{{ asset('storage/'.$sauna->image_path) }}" alt="サウナ画像" class="mt-2 h-32">
                                @endif
                            </div>
                        </div>
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('saunaComment')) ? $sauna->sauna_comment : old('saunaComment') }}</textarea>
                            </div>
                            {{-- サウナ備考のエラーメッセージ --}}
                            @error('saunaComment')
                                <div class="alert alert-danger text-red-700">{{ $message }}</div>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    value="1"
                                    {{ old('hasLoyly', $sauna->has_loyly) == '1' ? 'checked' : ''}}
                                >
                                ...
                                <input
                                    ...
                                    name="hasLoyly"
                                    class="col-span-2 border border-gray-300 p-2 rounded-lg"
                                    {{ old('hasLoyly', $sauna->has_loyly) == '0' ? 'checked' : '' }}
                                >
                            </div>
                            {{-- ロウリュのエラーメッセージ --}}
                            @error('hasLoyly')
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('loylyComment')) ? $sauna->loyly_comment : old('loylyComment') }}</textarea>
                            </div>
                            {{-- ロウリュ備考のエラーメッセージ --}}
                            @error('loylyComment')
                                <div class="alert alert-danger text-red-700">{{ $message }}</div>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    name="hasWaterbath"
                                    class="col-span-2 border border-gray-300 p-2 rounded-lg"
                                    {{ old('hasWaterbath', $sauna->has_water_bath) == '1' ? 'checked' : '' }}
                                >
                                ...
                                <input
                                    ...
                                    name="hasWaterbath"
                                    class="col-span-2 border border-gray-300 p-2 rounded-lg"
                                    {{ old('hasWaterbath', $sauna->has_water_bath) == '0' ? 'checked' : '' }}
                                >
                            </div>
                            {{-- 水風呂有無のエラーメッセージ --}}
                            @error('hasWaterbath')
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('waterbathComment')) ? $sauna->water_bath_comment : old('waterbathComment') }}</textarea>
                            </div>
                            {{-- 水風呂備考のエラーメッセージ --}}
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    name="hasOutdoorbath"
                                    class="col-span-2 border border-gray-300 p-2 rounded-lg"
                                    {{ old('hasOutdoorbath', $sauna->has_outdoor_bath) == '1' ? 'checked' : '' }}
                                >
                                ...
                                <input
                                    ...
                                    name="hasOutdoorbath"
                                    class="col-span-2 border border-gray-300 p-2 rounded-lg"
                                    {{ old('hasOutdoorbath', $sauna->has_outdoor_bath) == '0' ? 'checked' : '' }}
                                >
                            </div>
                            {{-- 外気浴のエラーメッセージ --}}
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    name="hasChair"
                                    class="col-span-2 border border-gray-300 p-2 rounded-lg"
                                    {{ old('hasChair', $sauna->has_chair) == '1' ? 'checked' : '' }}
                                >
                                ...
                                <input
                                    ...
                                    name="hasChair"
                                    class="col-span-2 border border-gray-300 p-2 rounded-lg"
                                    {{ old('hasChair', $sauna->has_chair) == '0' ? 'checked' : '' }}
                                >
                            </div>
                            {{-- ととのい椅子のエラーメッセージ --}}
                            @error('hasChair')
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                >{{ is_null(old('chairComment')) ? $sauna->chair_comment : old('chairComment') }}</textarea>
                            </div>
                            {{-- ととのい椅子備考のエラーメッセージ --}}
                            @error('chairComment')
                                <div class="alert alert-danger text-red-700">{{ $message }}</div>
